...
#define WK2XXX_RS485_PORT	2
static int wk2xxx_rs485_start(struct wk2xxx_port *p)
{
#ifdef WK2XXX_RS485_EN
	extern int rs485_start_tx(void);

	if (p->port.iobase == WK2XXX_RS485_PORT) {
		return rs485_start_tx();
	}
#endif
...
static int wk2xxx_rs485_stop(struct wk2xxx_port *p)
{
#ifdef WK2XXX_RS485_EN
	extern int rs485_stop_tx(void);

	if (p->port.iobase == WK2XXX_RS485_PORT) {
		return rs485_stop_tx();
	}
#endif
